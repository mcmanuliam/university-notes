Similar to [[Software Engineering/Year 2/Practical Algorithms/Units/7. Counting and Probability/7.2 Permutations]], only order of selected items is not relevant. 
